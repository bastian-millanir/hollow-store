...
function Form() {
    ...
    const handleSubmit = (e) => {
        ...
        if (allValid) {
            // comprobar si el envío es gratis antes de limpiar
            const esGratisAntesDeLimpiar = comprobarEnvioGratis(values.region, values.comuna);
            ...
            setMensajeEnvioGratis(esGratisAntesDeLimpiar ? '¡Tu envío es gratis en esta comuna!' : '');
        }
    };
    ...
    // funcion para validar el envío gratis
    ...
    // actualizar el mensaje cada vez que cambian región o comuna
                    ...
                    <div className="col-12 col-md-10 col-lg-8">
                        <div id="pre-register-form" className="card mx-auto p-4 rounded-4 shadow-sm"
                            ...
                            <div className="card-body">
                                ...
                                <div id="mensaje-envio-gratis" className="text-success text-center mt-2">{mensajeEnvioGratis}</div>
                            </div>
                        </div>
                    </div>
                </div>
